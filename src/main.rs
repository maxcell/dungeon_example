use bevy::{input::{common_conditions::input_toggle_active, mouse::MouseWheel}, prelude::*};
use bevy_asset_loader::asset_collection::AssetCollectionApp;
use bevy_ecs_tilemap::TilemapPlugin;
use bevy_inspector_egui::quick::WorldInspectorPlugin;
use dungeon_example::{assets::ImageAssets, map::{spawn_camera, spawn_world, update_camera}, player::{move_player, spawn_player}};
